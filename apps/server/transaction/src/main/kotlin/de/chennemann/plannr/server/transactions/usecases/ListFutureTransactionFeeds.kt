...
@Component
class ListAccountFutureTransactionFeedUseCase(
...
@Component
class ListPocketFutureTransactionFeedUseCase(
...
@Component
class ListContractHistoricalTransactionFeedUseCase(
    private val contractRepository: ContractRepository,
    private val pocketFeedRepository: R2dbcPocketTransactionFeedRepository,
    ...
    override suspend fun invoke(contractId: String, before: Long?, limit: Int): ListPocketTransactionFeed.Page {
        contractRepository.findById(contractId.trim()) ?: throw NotFoundException("not_found", "Contract not found", mapOf("id" to contractId.trim()))
...
@Component
class ListContractFutureTransactionFeedUseCase(
    private val contractRepository: ContractRepository,
    private val repository: PocketFutureTransactionFeedRepository,
