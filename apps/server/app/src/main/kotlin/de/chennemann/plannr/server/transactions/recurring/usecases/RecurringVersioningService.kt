...
class RecurringVersioningService(
    ...
    fun predecessorOccurrence(existing: de.chennemann.plannr.server.transactions.recurring.domain.RecurringTransaction, newFirstOccurrenceDate: String): String {
