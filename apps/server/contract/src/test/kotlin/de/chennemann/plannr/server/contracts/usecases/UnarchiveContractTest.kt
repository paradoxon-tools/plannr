...
class UnarchiveContractTest {
    ...
    fun `unarchives contract`() = runTest {
        ...
        val unarchiveContract = UnarchiveContractUseCase(repository, archiveCascade)
    ...
    fun `fails for unknown contract`() = runTest {
        val unarchiveContract = UnarchiveContractUseCase(InMemoryContractRepository(), RecordingContractRecurringTransactionCascade())
