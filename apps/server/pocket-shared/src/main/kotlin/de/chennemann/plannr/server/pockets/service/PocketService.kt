...
interface PocketService {
    ...
    suspend fun createForSavingGoal(command: CreatePocketForSavingGoalCommand): Pocket
    suspend fun updateForSavingGoal(command: UpdatePocketsForSavingGoalCommand)
    ...
    suspend fun archiveForSavingGoal(savingGoalId: Long)
    suspend fun unarchiveForSavingGoal(savingGoalId: Long)
    suspend fun delete(id: Long)
    suspend fun list(accountId: Long? = null, archived: Boolean? = null): List<Pocket>
    suspend fun listForSavingGoal(savingGoalId: Long): List<Pocket>
