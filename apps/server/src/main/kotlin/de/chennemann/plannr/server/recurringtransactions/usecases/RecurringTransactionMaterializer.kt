...
class RecurringTransactionMaterializer(
    private val recurringTransactionRepository: de.chennemann.plannr.server.recurringtransactions.domain.RecurringTransactionRepository,
    ...
    suspend fun materialize(recurring: de.chennemann.plannr.server.recurringtransactions.domain.RecurringTransaction, today: LocalDate = localDateProvider()): Int {
    ...
    fun calculateTargetDates(recurring: de.chennemann.plannr.server.recurringtransactions.domain.RecurringTransaction, today: LocalDate = localDateProvider()): List<LocalDate> {
